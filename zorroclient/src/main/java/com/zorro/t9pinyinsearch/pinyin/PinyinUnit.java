/*
 * Copyright  [handsomezhou] 2014 The T9 search Open Source Project
 *
...
package com.zorro.t9pinyinsearch.pinyin;

import java.util.ArrayList;
import java.util.List;

/**
 * PinyinUnit as a base data structure to context_menu_save the string that Chinese characters  converted to Pinyin characters.
 * for example:
...
public class PinyinUnit implements Cloneable {
	...
	private int mStartPosition; //context_menu_save starting index position that the variables in the original string.
	/*
	 * context_menu_save the string which single Chinese characters Pinyin(include Multiple Pinyin),or continuous non-kanji characters.
